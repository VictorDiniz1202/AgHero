...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    prop: "onAbrirBI",
    icon: (
      <div className="w-5 h-5 rounded-full bg-gradient-to-br from-vivid-emerald to-vivid-teal border border-white/60 shadow-inner flex items-center justify-center overflow-hidden shrink-0">
        {/* Espaço reservado para a foto do AgBoy */}
