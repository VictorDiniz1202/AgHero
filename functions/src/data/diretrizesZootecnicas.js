/**
 * functions/src/data/diretrizesZootecnicas.js
 *
 * Port (CommonJS) de agtech-hero/src/data/DiretrizesZootecnicas.js.
 * Mantida em sincronia manual: qualquer alteração nas metas/limites de
 * conforto térmico deve ser replicada em ambos os arquivos.
 */

const DIRETRIZES_ZOOTECNICAS = {
  "Cobb 500": {
    aptidao: "corte",
    metas_semanais: {
  ...
  "Lohmann": {
    ...
    consumo_agua_vs_racao: 2.0,
  },
};

module.exports = { DIRETRIZES_ZOOTECNICAS };
